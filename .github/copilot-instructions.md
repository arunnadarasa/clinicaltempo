...
> If you learned something non-obvious about Tempo or this repo, suggest a one-line addition to `CLAWHUB.md` (Successes or Failures).

EVVM-only work: `docs/EVVM_TEMPO.md`, `/evvm` — upstream deep doc: `https://www.evvm.info/llms-full.txt`.
